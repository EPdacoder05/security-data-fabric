...
class TestServiceAuth:
    ...
    def test_verify_service_token(self, service_auth):
        ...
        token = service_auth.create_service_token(
            service_name="test-service", scopes=["incidents:read"]
        )
    ...
    def test_has_scope(self, service_auth):
        ...
        token = service_auth.create_service_token(
            service_name="test-service", scopes=["incidents:read", "incidents:write"]
        )
    ...
    def test_admin_scope(self, service_auth):
        ...
        token = service_auth.create_service_token(
            service_name="admin-service", scopes=["admin:full"]
        )
    ...
    def test_require_scopes_success(self, service_auth):
        ...
        token = service_auth.create_service_token(
            service_name="test-service", scopes=["incidents:write"]
        )

        authorized, error = service_auth.require_scopes(token, ["incidents:write", "admin:full"])
    ...
    def test_require_scopes_failure(self, service_auth):
        ...
        authorized, error = service_auth.require_scopes(token, ["incidents:write"])
    ...
    def test_create_user_token(self, service_auth):
        ...
        token = service_auth.create_user_token(
            user_id="user-123", email="user@example.com", roles=["user", "analyst"]
        )
    ...
    def test_verify_user_token(self, service_auth):
        ...
        token = service_auth.create_user_token(
            user_id="user-123", email="user@example.com", roles=["user"]
        )
...
class TestTokenRotation:
    ...
    async def test_create_token_pair(self, token_rotation, test_db):
        ...
        access_token, refresh_token = await token_rotation.create_token_pair(
            db=test_db, user_id="user-123", email="user@example.com", roles=["user"]
        )
